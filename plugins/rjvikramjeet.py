...
async def rgvikramjeet_handler(client: Client, m: Message):
    ...
    topics = requests.get(
        f"https://rgvikramjeetapi.classx.co.in/get/alltopicfrmlivecourseclass?courseid={batch_id}&subjectid={subject_id}",
        headers=auth_headers,
    ).json()["data"]
    ...
    filename = f"Rgvikramjeet-{topic_name}.txt"
