...
#  Plugin: winners (Winners Institute – ClassX)
...
@Client.on_message(filters.command("winners"))
async def winners_handler(client: Client, m: Message):
    ...
    topics = session.get(
        f"https://winnersinstituteapi.classx.co.in/get/alltopicfrmlivecourseclass"
